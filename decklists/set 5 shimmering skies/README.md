...
This folder contains all set 5 (shimmering skies) decklists. Each decklist contains an indication on deck type, ink colors, cards and a small description on the playstyle.
...
- [Emerald Amber Discard](amber_emerald_discard.md)
- [Emerald Amethyst Aggro](amethyst_emerald_aggro.md)
